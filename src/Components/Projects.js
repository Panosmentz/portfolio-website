...
import { ReactComponent as ReduxIcon } from "../assets/tech icons/redux.svg";
import { ReactComponent as StripeIcon } from "../assets/tech icons/stripe.svg";
          ...
          <Grid item xs={12} md={4} align="center">
            <FadeInWhenVisible>
              <Card className={classes.card}>
                ...
                />
                <CardMedia className={classes.media} image={avo} title="avo" />
                <CardContent>
                  <Typography
                    variant="body2"
                    component="p"
                  ...
                  >
                    ...
                    Sanity.io, Redux and Stripe for payments. The app features
                    images and content generated by AI technologies(OpenAI &
                    Midjourney).Deployed on Vercel.
                  </Typography>
                </CardContent>
                <CardActions disableSpacing>
                  <a
                    href="https://avo-one.vercel.app/"
                    target="_blank"
                  ...
                  <a
                    href="https://github.com/Panosmentz/AvO"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Fab size="small" className={classes.icons}>
                ...
                <Collapse in={expanded9} timeout="auto" unmountOnExit>
                  <CardContent>
                    ...
                    <Grid container direction="row" alignItems="center">
                      <Grid item>
                        <TypeScriptIcon className={classes.techicon} />
                      </Grid>
                      <Grid item>
                        <Typography className={classes.description}>
                          {" "}
                    ...
                    <Grid container direction="row" alignItems="center">
                      <Grid item>
                        <SanityIcon className={classes.techicon} />
                      </Grid>
                      <Grid item>
                        <Typography className={classes.description}>
                          {" "}
                    ...
                    <Grid container direction="row" alignItems="center">
                      <Grid item>
                        <ReduxIcon className={classes.techicon} />
                      </Grid>
                      <Grid item>
                        <Typography className={classes.description}>
                          {" "}
                    ...
                    <Grid container direction="row" alignItems="center">
                      <Grid item>
                        <StripeIcon className={classes.techicon} />
                      </Grid>
                      <Grid item>
                        <Typography className={classes.description}>
                          {" "}
